...
contract RaffleTest is Test, CodeConstants {
    ...
    function testRaffleRevertsWHenYouDontPayEnought() public {
        ...
        vm.prank(PLAYER);
        // Act / Assert
        // vm expect should before the act
    ...
    function testEmitsEventOnEntrance() public {
        ...
        // Act / Assert
        // expectEmit with index should be ture. mostly has three index. forth is non-indexed
    ...
    function testPerformUpkeepRevertsIfCheckUpkeepIsFalse() public {
        ...
        // Act / Assert
        // encodeWithSelector use when use need to test a function with params
        vm.expectRevert(
        ...
        skipFork
    {
        ...
        for (
            ...
            // uint160 is a way to convert number to address
